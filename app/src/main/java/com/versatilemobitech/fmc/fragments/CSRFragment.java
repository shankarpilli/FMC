...
import com.versatilemobitech.fmc.parsers.CSRParser;
 ...
 */
public class CSRFragment extends Fragment implements IAsyncCaller, AdapterView.OnItemClickListener, AbsListView.OnScrollListener {
    public static final String TAG = "CSRFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mParent.getSupportActionBar().setTitle(Utility.setHeaderTypeface(mParent,
                Utility.getResourcesString(getActivity(), R.string.csr)));
    ...
    public void getCSRFromApi(String mPageNumber) {
        LinkedHashMap<String, String> paramMap = new LinkedHashMap<>();

        CSRParser mCSRParser = new CSRParser();
        if (Utility.isNetworkAvailable(mParent)) {
            ServerIntractorAsync serverIntractorAsync = new ServerIntractorAsync(mParent, Utility.getResourcesString(mParent,
                    ...
                    APIConstants.CSR_CATEGORY + mPageNumber, paramMap,
                    APIConstants.REQUEST_TYPE.GET, this, mCSRParser);
