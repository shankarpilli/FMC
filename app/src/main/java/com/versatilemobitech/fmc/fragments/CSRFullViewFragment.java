...
import com.versatilemobitech.fmc.adapters.CSRImageViewPagerAdapter;
...
public class CSRFullViewFragment extends Fragment {
    public static final String TAG = "CSRFullViewFragment";
    ...
    private CSRImageViewPagerAdapter imageViewPagerAdapter;
    ...
    private void initUI() {
        ...
        imageViewPagerAdapter = new CSRImageViewPagerAdapter(mParent, CSRViewFragment.galleryViewModels);
